...
&mdash; hence the name for this demo: Turtle.
...
\<code\>FORGET\</code\> operation. \<code\>FORGET\</code\> deletes from
the current dictionary in memory all the definitions from a word you
specify. In other words, you type \<code\>FORGET\</code\> plus the first
...
definition of Sin &mdash; the program loaded prior to Turtle.
...
------------------------------------------------------------------------
  ...
  ------------------------------------------- --------------------------------- -----------------------------------
  [Lesson 17](Lesson_17 "wikilink")           [Tutorial](Tutorial "wikilink")   [Lesson 19](Lesson_19 "wikilink")
