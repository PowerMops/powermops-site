...
\<blockquote\> **Note:** At present, \<code\>openResFile\</code\> is not
...
By saying &ldquo;if no error occurs&rdquo;, we really mean that
...
Note also, wherever you have \<code\>ASSERTIONS?\</code\> defined as a
